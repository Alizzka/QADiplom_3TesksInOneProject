...
public class FromAccountToConstructorYandexTest extends BaseYandexTest {
    ...
    @Test
    @Step("Тестирование перехода из личного кабинета в конструктор по клику на «Конструктор» в Yandex браузере")
    public void testConstructorButtonFromPersonalCabinetYandex() {
    ...
    // страницы логина, а должен быть url главной страницы
    @Test
    @Step("Тестирование перехода из личного кабинета в конструктор по клику на логотип Stellar Burgers в Yandex браузере")
    public void testConstructorButtonFromStellarBurgersLogoYandex() {
        loginPage.clickPersonalCabinetButton();
        loginPage.enterEmail("testuser@example.com");
        loginPage.enterPassword("password123");
        loginPage.submitLogin();
