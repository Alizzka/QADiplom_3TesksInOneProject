...
public class ConstructorYandexTest extends BaseYandexTest {


    @Test
    @Step("Проверка перехода в раздел 'Соусы' в Yandex браузере")
    ...
    @Test
    @Step("Проверка перехода в раздел 'Начинки' в Yandex браузере")
    ...
    @Test
    @Step("Проверка перехода в раздел 'Булки' в Yandex браузере")
